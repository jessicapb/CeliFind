        ...
        <nav class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center mr-[20px]">
                ...
                <div class="relative inline-block text-left">
                    <button id="dropdown-toggle" type="button" class="font-inter p-[9px]  w-full mt-[20px] text-[16px] text-black border-[#fcb666] border-2 rounded-[50px] font-normal hover:bg-[#fcb666] hover:text-[white] hover:font-normal hover:border-[#fcb666] hover:border-2 transition duration-200">
                    Administrador
                    </button>

                    <div id="dropdown-menu" class="font-inter hidden absolute left-0 mt-2 px-[10px] origin-top-center text-black bg-white border-1 shadow-lg rounded-[50px] z-10">
                        <div class="p-1 space-y-0.5">
                            <a class="font-inter flex items-center gap-x-2 w-full rounded-[50px] text-[12px] text-black font-normal hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:text-neutral-400 hover:w-full dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/logout">
                                <img class="w-[28%] h-[28%]" src="../../img/logout/logout.svg" alt="">
                                Tancar sessió
                            </a>
                        </div>
                    </div>
