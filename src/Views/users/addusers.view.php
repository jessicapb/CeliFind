...
<body>
    ...
    <section class="bg-slate-100 pb-[20px]">
        ...
        <h1 class="text-black font-calistoga opacity-[78%] text-[45px] font-bold mb-6 text-center pt-[26px]">Afegir <span class="text-[#96c368] opacity-[100%]">administrador</span></h1>
        ...
        <form class="flex justify-center pb-20" action="/saveuser" method="POST" enctype="multipart/form-data">
            <div class="w-[18%]">
                ...
                <!-- Postal code -->
                <div class="flex flex-col  mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Codi postal</label>
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black font-normal text-[16px] font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="postalcode" type="text" placeholder="escriu el codi postal">
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]" id="error-postalcode"></p>
                </div>
                
                <!-- Email -->
                <div class="flex flex-col  mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Correu electrònic</label>
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black font-normal text-[16px] font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="email" type="email" placeholder="escriu el correu electrònic">
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]" id="error-email"></p>
                </div>
                
                <!-- Password -->
                <div class="flex flex-col mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Contrasenya</label>
                    <div class="relative">
                        <input id="password" class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black font-normal text-[16px] font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow w-full" name="password" type="password" placeholder="escriu la contrasenya">
                    ...
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]" id="error-password"></p>
                </div>
    ...
    <!-- File errors -->
    <script src="../../js/users/error-users.js"></script>
