    ...
    <main>
        ...
        <section class="bg-slate-100">
            <div class="flex-col justify-center pt-36 p-10 text-center">
                ...
                <div class="mt-16">
                <a href="#" class="bg-[#fcb666] text-[18px] text-white p-3 px-6 border-2 border-[#fcb666] rounded-xl hover:bg-white hover:text-[#fcb666] transition duration-300 ease-in-out">Explora tots els llocs</a>
            </div>
        </div>
