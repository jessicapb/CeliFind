...
<head>
    ...
    <title>Afegir establiment</title>
        ...
        <form class="flex justify-center" action="/savestablishments" method="POST" enctype="multipart/form-data">
            <div class="w-[18%]">
                ...
                <div class="flex flex-col  mb-[15px]">
                    ...
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black font-normal text-[16px] font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="location" type="text" placeholder="escriu la localització">
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]"  id="error-location"></p>
                </div>
                
                <!-- Phonenumber -->
                <div class="flex flex-col  mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Número de telèfon</label>
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black text-[16px] font-normal font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="phonenumber" type="text" placeholder="escriu el número de telèfon">
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]"  id="error-phonenumber"></p>
                </div>
                
                <!-- Website-->
                <div class="flex flex-col  mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Lloc web</label>
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black text-[16px] font-normal font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="website" placeholder="escriu el lloc web">
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]"  id="error-website"></p>
                </div>
                
                <!-- Schedule -->
                <div class="flex flex-col  mb-[15px]">
                    <label class="mb-[4px] text-left text-black font-calistoga opacity-[78%] text-[20px] font-normal">Horari</label>
                    <textarea class="border border-[#fcb666] rounded-[9px] p-[8px] placeholder:text-black text-[16px] font-normal font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="schedule" placeholder="escriu l'horari"></textarea>
                    <p class="text-red-500 mt-[5px] font-inter hidden text-[15px]" id="error-schedule"></p>
                </div>
