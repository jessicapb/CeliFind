...
<head>
    ...
    <title>Gestor dels establiments</title>
...
<body>
    ...
    <section class="bg-slate-100 pb-[20px]">
        <div class="breadcrumb-container">
            <ul class="breadcrumb flex gap-2 pl-[20px] pt-[20px]">
                <li><a href="/establishmentsmanager" class="breadcrumb-link underline font-bold">Gestor establiments</a></li>                
            </ul>
        </div>
        
        <h1 class="text-black font-calistoga opacity-[78%] text-[45px] text-center font-bold pt-[26px]">Gestor <span class="text-[#96c368] opacity-[100%]">establiments</span></h1>
        
        <div class="mt-[20px] flex justify-between items-center">
            <!-- Add product  -->
            <div class="w-[50%]">
                <a class="font-inter bg-[#FCB666] text-white text-[16px] font-medium p-[9px] ml-[20px] mr-[5px] rounded-[9px] text-center transition-all hover: focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50" href="/establishmentsadd">Afegir establiments</a>
                <a class="font-inter bg-[#96c368] text-[#f5f5f5] text-[16px] font-medium p-[9px]  rounded-[9px] text-center transition-all focus:shadow-none active:bg-[#88c24d] hover:focus:bg-[#88c24d]  hover:bg-[#88c24d] disabled:pointer-events-none disabled:opacity-50" href="/establishmentsshowimage">Veure imatges</a>
            </div>
            ...
            <?php if (!empty($_SESSION['success_add'])): ?>
                <div class="updatemodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                    <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                        <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Establiment afegit</h2>
                        <p class="font-inter text-black font-medium text-[16px] text-center">L'establiment s'ha afegit correctament.</p>
                        <div class="flex justify-center">
                            <a href="/establishmentsmanager" class="font-inter bg-[#FCB666] mt-[10px] mr-[15px] text-[white] text-[16px] font-medium p-[9px] rounded-[9px] transition-all hover:focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50">Tancar</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Search part -->
            <form action="/searchestablishments" method="POST">
                <div class="w-full max-w-sm min-w-[200px] mr-[15px]">
                    <div class="relative flex items-center">
                        ...
                        <input name="name" class="w-[500px] bg-[#fefbf9] placeholder:text-black font-normal font-inter text-black text-[16px] border border-[#FCB666] rounded-[27px] pl-10 pr-3 py-2 transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] shadow-sm focus:shadow" placeholder="escriu els establiments">
                    </div>
                </div>
            </form>
        </div>
        ...
        <?php if (!empty($noResults)): ?>
            <div class="searchmodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                    ...
                    <div class="flex justify-center">
                        <a href="/establishmentsmanager" class="closesearchmodal font-inter bg-[#FCB666] mt-[10px] text-white text-[16px] font-medium p-[9px] rounded-[9px] transition-all hover:bg-[#ef9b3b] focus:outline-none">
                            Tancar
                        </a>
                    </div>
                </div>
        ...
        <table class="w-full m-auto mt-[50px] table-auto text-center border-separate border-spacing-[20px]">
            <thead>
                <tr>
                    ...
                    <th class="text-black font-calistoga text-[24px] font-bold pr-[10px]">Localització</th>
                    <th class="text-black font-calistoga text-[24px] font-bold pr-[10px]">Número de telèfon</th>
                    <th class="text-black font-calistoga text-[24px] font-bold pr-[10px]">Lloc web</th>
                    <th class="text-black font-calistoga text-[24px] font-bold pr-[10px]">Horari</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($establishments as $establishment) { ?>
                    ...
                    <tr>
                        ...
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getName();?>
                        </td>
                        <!-- Description -->
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getDescription();?> 
                        </td>
                        <!-- Ingredients -->
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getLocation(); ?> 
                        </td>
                        <!-- Ingredients -->
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getPhoneNumber(); ?> 
                        </td>
                        <!-- People -->
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getWebsite(); ?> 
                        </td>
                        <!-- Duration -->
                        <td class="border border-[#FCB666] p-[9px] bg-white">
                            <?php echo $establishment->getSchedule(); ?> 
                        </td>
                        <!-- Edit button -->
                        <td class="font-inter bg-[#FCB666] p-[9px] text-[white] text-[16px] font-medium p-[5px] rounded-[9px] transition-all hover: focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50">
                            <div class="flex justify-center">
                                <button type="submit" class="flex items-center edit-establishments-btn" 
                                        data-id="<?php echo $establishment->getId(); ?>" 
                                        data-name="<?php echo $establishment->getName(); ?>" 
                                        data-description="<?php echo $establishment->getDescription(); ?>" 
                                        data-phonenumber="<?php echo $establishment->getPhoneNumber(); ?>" 
                                        data-website="<?php echo $establishment->getWebsite(); ?>"
                                        data-schedule="<?php echo $establishment->getSchedule(); ?>">
                        ...
                        <?php if (!empty($_SESSION['success_update'])): ?>
                            <div class="updatemodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                                <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                                    <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Establiment actualitzat</h2>
                                    <p class="font-inter text-black font-medium text-[16px] text-center">L'establiment s'ha actualitzat correctament.</p>
                                    <div class="flex justify-center">
                                        <a href="/establishmentsmanager" class="font-inter bg-[#FCB666] mt-[10px] mr-[15px] text-[white] text-[16px] font-medium p-[9px] rounded-[9px] transition-all hover:focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50">Tancar</a>
                                    </div>
                                </div>
                        ...
                        <div class="deletemodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50 hidden">
                            <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                                <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Vols eliminar l'establiment <?php echo $establishment->getName() ?> ?</h2>
                                <p class="font-inter text-black- font-medium text-[16px] text-center">Un cop sigui eliminada no es podrà desfer l'operació.</p>
                                <div class="flex justify-center">
                                    <form action="/deleteestablishments" method="POST">
                        ...
                        <?php if (isset($_GET['deleted']) && $_GET['deleted'] == 'true'): ?>
                            <div class="deletemodal fixed inset-0 flex justify-center items-center bg-opacity-50 z-50">
                                <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                                    <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Eliminada l'establiment</h2>
                                    <div class="flex justify-center">
                                        <a href="/establishmentsmanager" class="font-inter bg-[#FCB666] mt-[10px] mr-[15px] text-[white] text-[16px] font-medium p-[9px] rounded-[9px] transition-all hover:focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50">Tancar</a>
                                    </div>
                                </div>
    ...
    <script src="../../js/establishments/editestablishments.js"></script>
