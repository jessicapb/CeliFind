...
<form action="/userregister" method="POST" class="w-full max-w-md flex flex-col gap-6 mb-4">
    <div>
        ...
        <input class="w-full border border-[#fcb666] rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#fcb666] placeholder-gray-500" type="text" name="name" id="name" placeholder="escriu el nom">
