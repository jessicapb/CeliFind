...
<body class="bg-slate-100 flex flex-col items-center justify-center min-h-screen px-2">
    ...
    <form action="/resetpassword" method="POST" class="w-full max-w-md flex flex-col gap-4 p-6 sm:p-8">
        ...
        <div>
            ...
            <input class="w-full border border-[#fcb666] rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#fcb666] placeholder-gray-500" type="password" name="password" id="password" placeholder="nova contrasenya" required>
