    ...
    <section class="bg-slate-100 pb-[20px]">
        <div class="breadcrumb-container">
            <ul class="breadcrumb flex gap-2 pl-[20px] pt-[20px]">
                <li><a href="/category" class="breadcrumb-link underline font-bold">Gestor categories</a></li>                
            </ul>
        </div>
        ...
        <div class="mt-[20px] flex justify-between items-center">
            <!-- Add Category  -->
            <div class="w-[50%]">
                <a class="font-inter bg-[#FCB666] text-white text-[16px] font-medium p-[9px] ml-[20px] mr-[5px] rounded-[9px] text-center transition-all hover: focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50" href="/categoryadd">Afegir categories</a>
        ...
        <?php if (!empty($_SESSION['success_add'])): ?>
            <div class="updatemodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                    <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Categoria afegida</h2>
                    <p class="font-inter text-black font-medium text-[16px] text-center">La categoria s'ha afegit correctament.</p>
                    ...
                    <?php foreach ($categories as $category) { ?>
                        <tr>
                            ...
                            <?php if (!empty($_SESSION['success_update'])): ?>
                                <div class="updatemodal fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50 z-50">
                                    <div class="bg-white p-6 rounded-lg shadow-lg w-[32%]">
                                        <h2 class="text-black font-calistoga text-[24px] font-bold mb-[10px] text-center">Categoria actualitzada</h2>
                                        <p class="font-inter text-black font-medium text-[16px] text-center">La categoria s'ha actualitzat correctament.</p>
                                        <div class="flex justify-center">
                                            <a href="/category" class="font-inter bg-[#FCB666] mt-[10px] mr-[15px] text-[white] text-[16px] font-medium p-[9px] rounded-[9px] transition-all hover:focus:bg-[#ef9b3b] focus:shadow-none active:bg-[#ef9b3b] hover:bg-[#ef9b3b] disabled:pointer-events-none disabled:opacity-50">Tancar</a>
                                        </div>
                                    </div>
