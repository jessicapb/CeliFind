        ...
        <form class="flex justify-center" action="/savecategory" method="POST" enctype="multipart/form-data">
            <div class="w-[18%]">
                ...
                <div class="flex flex-col  mb-[15px]">
                    ...
                    <input class="border border-[#fcb666] rounded-[9px] p-[8px] bg-white placeholder:text-black font-normal text-[16px] font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" name="name" type="text" placeholder="escriu el nom">
                ...
                <div class="flex flex-col  mb-[15px]">
                    ...
                    <textarea name="description" class="border border-[#fcb666]  bg-white rounded-[9px] p-[8px] placeholder:text-black text-[16px] font-normal font-inter transition duration-300 ease focus:outline-none focus:border-[#ef9b3b] hover:border-[#ef9b3b] focus:shadow" type="text-area" placeholder="escriu la descripció"></textarea>
                ...
                <div class="flex flex-col mb-[15px]">
                    ...
                    <div id="image-trigger" class="bg-white relative p-[8px] border border-[#fcb666] rounded-[9px] flex items-center justify-center cursor-pointer">
