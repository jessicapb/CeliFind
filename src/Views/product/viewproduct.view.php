            ...
            <div class="btn">
                <div class="flex items-center gap-x-2 text-[20px] font-semibold mt-4">
                    <button  class="font-calistoga flex items-center gap-x-3 px-4 py-2 rounded-full text-[17px] text-black opacity-[78%] font-light">
                        <img class="w-4 h-4 rotate-90" src="../../img/categoria/flecha-correcta.png" alt="flecha"><img class="w-10 h-10 object-contain" src="<?php echo htmlspecialchars($category['image']); ?>" alt="officialimage" id="officialimage"><?php echo htmlspecialchars($category['name']); ?>
                    </button>
                </div>
